...
public class Download_Suite_Client_Reviewer extends Base_PNC_Login {

    @Test(priority = 1)
    public void TC04_Verify_if_the_user_able_to_download_the_New_Joiner_Records_form_in_the_Client_Reviewer_Role() throws InterruptedException, IOException {
    ...
    @Test(priority = 2)
    public void TC05_Verify_if_the_user_able_to_download_the_New_Joiner_Records_form_for_Future_Processing_period_in_the_Client_Reviewer_Role() throws InterruptedException, IOException {
    ...
    @Test(priority = 3)
    public void TC08_Verify_if_the_user_able_to_download_the_Time_and_Attendance_in_the_Client_Reviewer_Role() throws InterruptedException, IOException {
        Download_Utility_Client_Reviewer download_utility = new Download_Utility_Client_Reviewer(driver);
    ...
    @Test(priority = 4)
    public void TC09_Verify_if_the_user_able_to_download_the_Time_and_Attendance_for_Future_Processing_Period_in_the_Client_Reviewer_Role() throws InterruptedException, IOException {
        Download_Utility_Client_Reviewer download_utility = new Download_Utility_Client_Reviewer(driver);
    ...
    @Test(priority = 5)
    public void TC11_Verify_if_the_user_able_to_download_the_Bank_Form_in_the_Client_Reviewer_Role() throws InterruptedException, IOException {
        Download_Utility_Client_Reviewer download_utility = new Download_Utility_Client_Reviewer(driver);
    ...
    @Test(priority = 6)
    public void TC15_Verify_if_the_user_able_to_Download_the_Approved_records_for_New_Joiner_form_in_the_Intelligent_Input_Control_Tab() throws InterruptedException, IOException {
    ...
    @Test(priority = 7)
    public void TC18_Check_if_the_User_able_to_click_the_Multisheet_Download_Button_Before_Generate_the_Data() throws InterruptedException, IOException {
    ...
    @Test(priority = 8)
    public void TC19_Check_if_the_User_able_to_select_the_particular_Processing_Period_Processing_For_PayRun_Type_and_Click_the_Multisheet_Download() throws InterruptedException, IOException {

...
public class Download_Suite_Checker_Bugfix extends Base_PNC_Login {


    @Test(priority = 1)
    public void tc16_Check_if_the_user_able_to_download_and_view_all_the_records_for_New_joiner_Form_Bugfix() throws InterruptedException, IOException, AWTException {
    ...
    @Test(priority = 2)
    public void tc41_Check_if_the_user_able_to_download_and_view_all_the_records_for_Bank_Form_Bugfix() throws InterruptedException, IOException, AWTException {
    ...
    @Test(priority = 3)
    public void tc29_Check_if_the_user_able_to_download_and_view_all_the_records_for_Time_and_Attendance_Bugfix() throws InterruptedException, IOException, AWTException {
